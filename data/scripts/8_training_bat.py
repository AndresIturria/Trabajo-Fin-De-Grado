...
start = time.time()
df = pd.read_csv("../intermediate-steps/batting_step3.csv")
df2 = pd.read_csv("../intermediate-steps/battingprediction_step2.csv")
...
df3 = pd.read_csv("../intermediate-steps/battingprediction_step1.csv")
df3["points"] = y[0]
df3.sort_values(by=["points"], ascending=False, inplace=True)
df3.to_csv("../finished-data/training_bat.csv", index=False)
